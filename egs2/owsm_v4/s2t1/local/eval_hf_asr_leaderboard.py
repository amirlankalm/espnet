...
Example:
    python local/eval_hf_asr_leaderboard.py --data data/lb_librispeech_test_clean \
        ...
        --early_stop true --out exp/hf_asr_leaderboard/test_clean_base_bs8.json
"""
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--maxlenratio", type=float, default=1.0)
    parser.add_argument(
        "--early_stop",
        type=str2bool,
        default=False,
        help="stop the beam search of an utterance as soon as its n-best list "
        "cannot change any more (Speech2Text option)",
    )
    parser.add_argument(
        "--sort",
        type=str2bool,
...
def main() -> None:
    ...
    print(
        ...
        f"{' early_stop' if args.early_stop else ''}{' sorted' if args.sort else ''}"
